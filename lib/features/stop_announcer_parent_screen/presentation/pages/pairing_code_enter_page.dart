  ...
  Widget build(BuildContext context) {
    return BlocListener<BusDataCubit, BusDataState>(
      ...
      child: Scaffold(
        ...
        body: BlocConsumer<BusDataCubit, BusDataState>(
          listener: (context, state) {
            if (state.status == BusDataStatus.error) {
              AppCommonMethods.commonSnackbar(context: context, message: "Enter valid pairing code");
            }
          },
          builder: (context, state) {
             if (state.status == BusDataStatus.loading) {
